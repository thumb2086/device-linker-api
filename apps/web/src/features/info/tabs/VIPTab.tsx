...
const VIP_TIERS: VipTier[] = [
  { name: '普通會員', threshold: 0, maxBet: 1_000, dailyBonus: 1.0, feeDiscount: 0, danmakuColor: '#a0a0a0' },
  { name: '青銅會員', threshold: 10_000, maxBet: 5_000, dailyBonus: 1.1, feeDiscount: 2, danmakuColor: '#cd7f32' },
  { name: '白銀會員', threshold: 100_000, maxBet: 20_000, dailyBonus: 1.2, feeDiscount: 4, danmakuColor: '#c0c0c0' },
  { name: '黃金會員', threshold: 1_000_000, maxBet: 100_000, dailyBonus: 1.3, feeDiscount: 6, danmakuColor: '#ffd700' },
  { name: '白金會員', threshold: 10_000_000, maxBet: 500_000, dailyBonus: 1.4, feeDiscount: 8, danmakuColor: '#e5e4e2' },
  { name: '鑽石等級', threshold: 50_000_000, maxBet: 2_000_000, dailyBonus: 1.5, feeDiscount: 10, danmakuColor: '#b9f2ff' },
  { name: '黑鑽等級', threshold: 100_000_000, maxBet: 10_000_000, dailyBonus: 1.6, feeDiscount: 12, danmakuColor: '#000000' },
  { name: '菁英等級', threshold: 200_000_000, maxBet: 20_000_000, dailyBonus: 1.7, feeDiscount: 14, danmakuColor: '#ff6b6b' },
  { name: '宗師等級', threshold: 500_000_000, maxBet: 50_000_000, dailyBonus: 1.8, feeDiscount: 16, danmakuColor: '#4ecdc4' },
  { name: '王者等級', threshold: 1_000_000_000, maxBet: 100_000_000, dailyBonus: 1.9, feeDiscount: 18, danmakuColor: '#ffe66d' },
  { name: '至尊等級', threshold: 2_000_000_000, maxBet: 200_000_000, dailyBonus: 2.0, feeDiscount: 20, danmakuColor: '#a8e6cf' },
  { name: '蒼穹等級', threshold: 5_000_000_000, maxBet: 300_000_000, dailyBonus: 2.1, feeDiscount: 22, danmakuColor: '#7b68ee' },
  { name: '寰宇等級', threshold: 10_000_000_000, maxBet: 500_000_000, dailyBonus: 2.2, feeDiscount: 24, danmakuColor: '#00ced1' },
  { name: '星穹等級', threshold: 20_000_000_000, maxBet: 700_000_000, dailyBonus: 2.3, feeDiscount: 26, danmakuColor: '#ff1493' },
  { name: '萬界等級', threshold: 50_000_000_000, maxBet: 850_000_000, dailyBonus: 2.4, feeDiscount: 28, danmakuColor: '#ff4500' },
  { name: '創世等級', threshold: 100_000_000_000, maxBet: 900_000_000, dailyBonus: 2.5, feeDiscount: 30, danmakuColor: '#ffd700' },
  { name: '神諭等級', threshold: 1_000_000_000_000, maxBet: 1_000_000_000, dailyBonus: 2.6, feeDiscount: 32, danmakuColor: '#ff00ff' },
  { name: '神諭一階', threshold: 2_000_000_000_000, maxBet: 2_000_000_000, dailyBonus: 2.7, feeDiscount: 34, danmakuColor: '#ff69b4' },
  { name: '神諭二階', threshold: 5_000_000_000_000, maxBet: 5_000_000_000, dailyBonus: 2.8, feeDiscount: 36, danmakuColor: '#da70d6' },
  { name: '神諭三階', threshold: 10_000_000_000_000, maxBet: 10_000_000_000, dailyBonus: 2.9, feeDiscount: 38, danmakuColor: '#ba55d3' },
  { name: '神諭四階', threshold: 20_000_000_000_000, maxBet: 20_000_000_000, dailyBonus: 3.0, feeDiscount: 40, danmakuColor: '#9370db' },
  { name: '神諭五階', threshold: 50_000_000_000_000, maxBet: 50_000_000_000, dailyBonus: 3.1, feeDiscount: 42, danmakuColor: '#8a2be2' },
  { name: '神諭六階', threshold: 100_000_000_000_000, maxBet: 100_000_000_000, dailyBonus: 3.2, feeDiscount: 44, danmakuColor: '#9400d3' },
  { name: '神諭七階', threshold: 200_000_000_000_000, maxBet: 200_000_000_000, dailyBonus: 3.3, feeDiscount: 46, danmakuColor: '#9932cc' },
  { name: '神諭八階', threshold: 500_000_000_000_000, maxBet: 500_000_000_000, dailyBonus: 3.4, feeDiscount: 48, danmakuColor: '#8b008b' },
  { name: '神諭九階', threshold: 1_000_000_000_000_000, maxBet: 1_000_000_000_000, dailyBonus: 3.5, feeDiscount: 50, danmakuColor: '#4b0082' },
  { name: '神諭十階', threshold: 2_000_000_000_000_000, maxBet: 2_000_000_000_000, dailyBonus: 3.6, feeDiscount: 55, danmakuColor: '#483d8b' },
  { name: '神諭十一階', threshold: 5_000_000_000_000_000, maxBet: 5_000_000_000_000, dailyBonus: 3.7, feeDiscount: 60, danmakuColor: '#2f4f4f' },
  { name: '神諭十二階', threshold: 10_000_000_000_000_000, maxBet: 10_000_000_000_000, dailyBonus: 3.8, feeDiscount: 65, danmakuColor: '#191970' },
];
