...
export const YJC_CONTRACT_ADDRESS = String(
    process.env.YJC_CONTRACT_ADDRESS || "0x82D6aDB17d58820324D86B378775350D03a071AE"
).trim();
export const YJC_TOKEN_DECIMALS = Number(process.env.YJC_TOKEN_DECIMALS || 18);
export const YJC_INITIAL_SUPPLY = String(process.env.YJC_INITIAL_SUPPLY || "100000000").trim();
