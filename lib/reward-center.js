...
function normalizeActiveBuffs(entries) {
    ...
    return entries
        .map((entry) => {
            ...
            expiresAt: trimText(entry && entry.expiresAt, 64),
            remainingUses: rawRemainingUses === null || rawRemainingUses === undefined || rawRemainingUses === "" ? null : Number(rawRemainingUses),
            ...
            remainingMaxBonus: rawRemainingMaxBonus === null || rawRemainingMaxBonus === undefined || rawRemainingMaxBonus === "" ? null : Number(rawRemainingMaxBonus),
