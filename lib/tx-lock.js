...
export async function acquireChainTxLock(timeoutMs = DEFAULT_CHAIN_TX_TIMEOUT_MS) {
...
export async function withChainTxLock(task, timeoutMs = DEFAULT_CHAIN_TX_TIMEOUT_MS) {
