export const VIP_TIERS = [
    ...
    { threshold: 500000000, label: "菁英 VIP", maxBet: 50000000 },
    { threshold: 1000000000, label: "宗師 VIP", maxBet: 80000000 },
    ...
    { threshold: 12000000000, label: "星穹 VIP", maxBet: 380000000 },
    { threshold: 20000000000, label: "萬界 VIP", maxBet: 480000000 },
    { threshold: 30000000000, label: "不朽 VIP", maxBet: 600000000 },
    { threshold: 50000000000, label: "永恆 VIP", maxBet: 720000000 },
    { threshold: 80000000000, label: "天選 VIP", maxBet: 860000000 },
    { threshold: 100000000000, label: "星耀 VIP", maxBet: 880000000 },
    { threshold: 150000000000, label: "聖域 VIP", maxBet: 900000000 },
    { threshold: 250000000000, label: "神域 VIP", maxBet: 920000000 },
    { threshold: 400000000000, label: "主宰 VIP", maxBet: 940000000 },
    { threshold: 600000000000, label: "永耀 VIP", maxBet: 960000000 },
    { threshold: 800000000000, label: "創世 VIP", maxBet: 980000000 },
...
export function getVipTierIndexByLabel(label) {
    ...
    return VIP_TIERS.findIndex((tier) => tier.label === normalized);
}
